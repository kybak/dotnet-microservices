...
using MicroserviceProject.Services.Catalog.Catalog.API.IntegrationEvents;
...
using MicroserviceProject.Services.Catalog.Catalog.API.ViewModel;
...
namespace MicroserviceProject.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        {
            System.Console.WriteLine("Catalog Controller....");
        ...
        {
            _logger.LogInformation($"Received product: {JsonConvert.SerializeObject(product)}");
            ...
            _logger.LogInformation($"created ID: {item.Id}");
            var locationUri = $"/api/v1/catalog/items/{item.Id}";
